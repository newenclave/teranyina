...
#include "client-core/iface/IFilesystem.h"
...
namespace ta { namespace client { namespace interfaces {
    ...
    namespace {
        ...
        struct dir_iter_impl: public filesystem::directory_iterator_impl {
            ...
            core                               &core_;
            std::shared_ptr<vcomm::rpc_channel> channel_;
...
namespace filesystem {
    ...
    namespace {
        ...
        struct fs_impl: public filesystem::iface {
            ...
            fs_impl( core &cl, const std::string &path )
                :core_(cl)
                ,channel_(cl.get_client( ).create_channel( ))
                ,client_(channel_)
                ,path_(path)
                ,hdl_(open_fs_inst(client_, path_))
            { }

            fs_impl( core &cl, vtrc::common::rpc_channel *chan,
